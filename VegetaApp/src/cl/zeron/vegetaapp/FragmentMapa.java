...
com.google.android.gms.location.LocationListener {
	...
	protected void mostrarDialogLocal() {
		...
		// Comentado ya que aun no est� la variable global globalClass
		((Button) dialogLocal.findViewById(R.id.aceptar)).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// Si los campos est�n rellenos se procede a guardar en la base de datos
				Location myLoc = (currentLocation == null) ? lastLocation : currentLocation;
	        	if(myLoc == null){
	        		Toast.makeText(getActivity(), "Problemas con su ubicaci�n, intenelo de nuevo",Toast.LENGTH_SHORT).show();
	        		return;
							...
							query.findInBackground(new FindCallback<ParseObject>() {
								...
								public void done(List<ParseObject> list, ParseException e) {
									if(e==null){
										...
										// Ya se encontr� el Id del objeto creado.
	...
	public class MarkerInfoWindowAdapter implements GoogleMap.InfoWindowAdapter{
		...
		public View getInfoContents(Marker marker) {
			...
			if(hashRestaurant.containsKey(marker)){
				...
				Toast.makeText(getActivity(), "No se encontr� el Marcador en los registros (?)", Toast.LENGTH_SHORT).show();
				return null;
			}

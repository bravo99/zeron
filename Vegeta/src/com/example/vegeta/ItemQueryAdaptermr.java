...
public class ItemQueryAdaptermr extends BaseAdapter{

	protected Activity activity;
	protected ArrayList<ParseObject> items;
	String[] info;
	final static String ACT_INFO = "com.example.vegeta.Result1";

	
	
	public  ItemQueryAdaptermr(Activity activity , ArrayList<ParseObject> items) {
	...
	private void lanzar(String[] algo) {
		...
		Intent a = new Intent(activity,Result1.class );
